...
function eliminate_weightmatrix=eliminate_interval(estimate_weightmatrix, interval_effect, no_sensors)
...
if interval_effect(2) !=0

end

%For spddsy
%spddsy always influence all the intervals
if interval_effect(3) !=0

end     

%For rt
%cap always influence all the intervals
if interval_effect(4) !=0
