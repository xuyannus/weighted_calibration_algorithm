...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%iteration = 100; %max number of estimate times, the higher the more precise, but it'll take more time
%the vectors below stands for [ODs cap spddsy rt_choice] 
estimate_part= [1;1;1;0]; %the part in Wh we estimate,1 represent this part exist.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
threshold = 0.3;
interval_effect=[1,0,0,0];%OD,cap,spd,rt
%how much interval we should consider besides the current interval,if set 0, then all the interval will be considered, many times 1 is enough.
